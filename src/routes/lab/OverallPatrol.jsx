...
//
class OverallPatrol extends Reflux.Component {
    constructor(props) {
        super(props);
...
@Form.create()
class OverallPatrolModal extends React.Component {
    constructor(props){
        super(props);
        this.state = {
...
export default withModal(AppActions.Alarm, OverallPatrolModal)(OverallPatrol);
