...
//
class RoutinePatrol extends Reflux.Component {
    constructor(props) {
        super(props);
...
@Form.create()
class RoutinePatrolModal extends React.Component {
    constructor(props){
        super(props);
        this.state = {
...
export default withModal(AppActions.Alarm, RoutinePatrolModal)(RoutinePatrol);